...
\newpage
   ...
   Gathered requirements, designed and developed mobile software for clients. 
    ...
    \begin{itemize}
      ...
      \item Real estate listing for local real estate agents (iPhone)
      \item Un-named mobile application used by a local doctor to compose and print reports for patients
    \end{itemize}
